            ...
            <div class="col-lg-9 offset-lg-2 text-center">
                <div class="hero-text">
                    <div class="hero-text-tablecell">
                        ...
                        <div class="hero-btns">
                            <a href="{{route('frontend.checkout')}}" class="boxed-btn">VEHICLE COLLECTION</a>
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1 text-center">
                <div class="testimonial-sliders">
                    ...
                    <div class="single-testimonial-slider">
                        <div class="client-avater">
                            <img src="{{asset('assets/frontend/img/avaters/avatar2.png')}}" alt="">
                        </div>
                        <div class="client-meta">
                    ...
                    <div class="single-testimonial-slider">
                        <div class="client-avater">
                            <img src="{{asset('assets/frontend/img/avaters/avatar3.png')}}" alt="">
                        </div>
                        <div class="client-meta">
...
<section class="shop-banner">
    <div class="container">
        <h3 style="color: white;">November sale is on! <br> with big <span class="orange-text">Discount...</span></h3>
        <div class="sale-percent"><span style="color: white;" >Sale! <br> Upto</span>50% <span style="color: white;">off</span></div>
        <a href="{{route('frontend.vehicle')}}" class="cart-btn btn-lg">Shop Now</a>
    </div>
</section>
<!-- end shop banner -->
